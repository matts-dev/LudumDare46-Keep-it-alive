import * as EmeraldUtils from "../tools/EmeraldUtils/emerald-opengl-utils.js";
import {UnitCube3D, texturedCubeFactory, coloredCubeFactory} from "../tools/EmeraldUtils/emerald_easy_shapes.js";
import * as key from "../tools/EmeraldUtils/browser_key_codes.js";
import {Camera} from "../tools/EmeraldUtils/emerald-opengl-utils.js";
import {vec2, vec3, vec4, mat4} from "../tools/gl-matrix_esm/index.js";
import {RenderBox3D, GlyphRenderer} from "../tools/EmeraldUtils/BitmapFontRendering.js"
import * as BMF from "../tools/EmeraldUtils/BitmapFontRendering.js"
import { Montserrat_BMF } from "../tools/EmeraldUtils/Montserrat_BitmapFontConfig.js";
import { Piano, Scale } from "../tools/EmeraldUtils/music_tools.js";
import * as Music from "../tools/EmeraldUtils/music_tools.js";
import {isSafari} from "../tools/EmeraldUtils/browser_key_codes.js";
...
class Game
{
    constructor(glCanvasId = "#glCanvas")
    {
        ...
        //create pianos
        // this.piano = new Piano(this.gl, "../tools/Sounds/PianoKeySounds/");
    ...
    _createTextures(gl){
        return {
            grass : new EmeraldUtils.Texture(gl, "../tools/Grass2.png"),
            montserratFontWhite : new EmeraldUtils.Texture(gl, "../tools/Montserrat_ss_alpha_white_power2.png"),
            montserratFontBlack : new EmeraldUtils.Texture(gl, "../tools/Montserrat_ss_alpha_black_power2.png"),
            montserratFont : new EmeraldUtils.Texture(gl, "../tools/Textures/Fonts/Montserrat_ss_alpha_1024x1024_wb.png"),
        }
    }
