...
class PianoSettingsStatics
{
    constructor(gl)
    {
        this.gl = gl;
        this.textures = {
            gearIcon : new EmeraldUtils.Texture(gl, "../tools/Textures/Icons/GearIcon.png"),
            scale : new EmeraldUtils.Texture(gl, "../tools/Textures/MusicTool/MusicScaleIcon.png"),
            scaleLock : new EmeraldUtils.Texture(gl, "../tools/Textures/MusicTool/MusicScale_Locked.png"),
            newPiano : new EmeraldUtils.Texture(gl, "../tools/Textures/MusicTool/NewPianoIcon.png"),
            chords :  new EmeraldUtils.Texture(gl, "../tools/Textures/MusicTool/Chords.png"),
            search :  new EmeraldUtils.Texture(gl, "../tools/Textures/MusicTool/Binoculars.png"),
            setScale :  new EmeraldUtils.Texture(gl, "../tools/Textures/MusicTool/NewScaleIcon.png"),
            removeScale : new EmeraldUtils.Texture(gl, "../tools/Textures/MusicTool/RemoveScaleIcon.png"),
            searchParameters :  new EmeraldUtils.Texture(gl, "../tools/Textures/MusicTool/SearchParameters.png"),
            blankCircle : new EmeraldUtils.Texture(gl, "../tools/Textures/MusicTool/BlankCircle.png"),
        };
    }
}
...
export class PianoManager extends SceneNode
{
    constructor(gl, glCanvas, piano, camera)
    {
        ...
        if (piano == null){ piano = new Piano(gl, "../tools/Sounds/PianoKeySounds/", 2);}
